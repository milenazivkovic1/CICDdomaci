    ...
    return (
      ...
      <div className="flex-container">
          <div className="Home-paragraf">
              <p>
                <br></br> <br></br> Dobrodošli na PocketCinema website, enciklopediju filmova! Naša veb stranica je 
                ...
                ogromnom kolekcijom filmova iz različitih žanrova i epoha. Naš korisnički interfejs olakšava pretragu 
